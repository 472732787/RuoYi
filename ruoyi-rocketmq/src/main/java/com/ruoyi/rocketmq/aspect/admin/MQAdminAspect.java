 ...
 */
package com.ruoyi.rocketmq.aspect.admin;

import java.lang.reflect.Method;

import com.ruoyi.rocketmq.service.client.MQAdminInstance;
...
public class MQAdminAspect {
    ...
    @Pointcut("execution(* com.ruoyi.rocketmq.service.client.MQAdminExtImpl..*(..))")
    public void mQAdminMethodPointCut() {

    }

    @Pointcut("@annotation(com.ruoyi.rocketmq.aspect.admin.annotation.MultiMQAdminCmdMethod)")
